...
void AFG22_EndlessRunnerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AFG22_EndlessRunnerCharacter::Look);
...
void AFG22_EndlessRunnerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
